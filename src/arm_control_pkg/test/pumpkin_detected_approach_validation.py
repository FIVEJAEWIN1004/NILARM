...
MODEL_CANDIDATES = (
    REPOSITORY_ROOT / "src/vision_pkg/models/nil_pumpkin.pt",
    REPOSITORY_ROOT / "src/vision_pkg/models/pumpkin_best.pt",
    REPOSITORY_ROOT / "src/vision_pkg/models/best.pt",
)
