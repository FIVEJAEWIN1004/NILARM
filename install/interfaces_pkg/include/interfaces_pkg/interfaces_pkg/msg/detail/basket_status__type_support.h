...
#ifndef INTERFACES_PKG__MSG__DETAIL__BASKET_STATUS__TYPE_SUPPORT_H_
#define INTERFACES_PKG__MSG__DETAIL__BASKET_STATUS__TYPE_SUPPORT_H_
...
#endif  // INTERFACES_PKG__MSG__DETAIL__BASKET_STATUS__TYPE_SUPPORT_H_
