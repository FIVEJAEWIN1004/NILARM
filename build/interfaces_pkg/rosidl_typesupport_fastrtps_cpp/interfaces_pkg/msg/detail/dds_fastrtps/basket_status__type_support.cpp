...
#include "interfaces_pkg/msg/detail/basket_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_pkg::msg::BasketStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::BasketStatus & ros_message)
{
  // Member: weight
  cdr >> ros_message.weight;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces_pkg
max_serialized_size_BasketStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::BasketStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces_pkg
max_serialized_size_key_BasketStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::BasketStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::BasketStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BasketStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::BasketStatus *>(
...
static size_t _BasketStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BasketStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BasketStatus__callbacks = {
  "interfaces_pkg::msg",
  "BasketStatus",
...
static rosidl_message_type_support_t _BasketStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BasketStatus__callbacks,
...
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_BasketStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, BasketStatus)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_BasketStatus__handle;
}
