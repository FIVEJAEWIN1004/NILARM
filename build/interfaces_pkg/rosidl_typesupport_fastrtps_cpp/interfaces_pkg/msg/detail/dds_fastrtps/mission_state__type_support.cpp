...
#include "interfaces_pkg/msg/detail/mission_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces_pkg::msg::MissionState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces_pkg::msg::MissionState & ros_message)
{
  // Member: state
  cdr >> ros_message.state;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg::msg::MissionState;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces_pkg
max_serialized_size_key_MissionState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const interfaces_pkg::msg::MissionState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces_pkg::msg::MissionState *>(
    untyped_ros_message);
...
{
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces_pkg, msg, MissionState)() {
  return &interfaces_pkg::msg::typesupport_fastrtps_cpp::_MissionState__handle;
}
